...
pub struct AccountProductAccessNullable {
    ///Allow the application to access specific products on this account
    #[serde(rename = "AccountProductAccess")]
    pub account_product_access: AccountProductAccess,
}
impl std::fmt::Display for AccountProductAccessNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for AddressDataNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for AddressNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct EmployeeIncomeSummaryFieldString {
    ...
    #[serde(rename = "IncomeSummaryFieldString")]
    pub income_summary_field_string: Option<IncomeSummaryFieldString>,
}
impl std::fmt::Display for EmployeeIncomeSummaryFieldString {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for EmployerIncomeSummaryFieldString {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct ExternalPaymentScheduleGet {
    ...
    #[serde(rename = "ExternalPaymentScheduleBase")]
    pub external_payment_schedule_base: Option<ExternalPaymentScheduleBase>,
}
impl std::fmt::Display for ExternalPaymentScheduleGet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for ExternalPaymentScheduleRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for ItemStatusNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct NumbersAchNullable {
    ...
    #[serde(rename = "NumbersACH")]
    pub numbers_ach: NumbersAch,
}
impl std::fmt::Display for NumbersAchNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct NumbersBacsNullable {
    ...
    #[serde(rename = "NumbersBACS")]
    pub numbers_bacs: NumbersBacs,
}
impl std::fmt::Display for NumbersBacsNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct NumbersEftNullable {
    ...
    #[serde(rename = "NumbersEFT")]
    pub numbers_eft: NumbersEft,
}
impl std::fmt::Display for NumbersEftNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct NumbersInternationalNullable {
    ...
    #[serde(rename = "NumbersInternational")]
    pub numbers_international: NumbersInternational,
}
impl std::fmt::Display for NumbersInternationalNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for PaymentConsentMaxPaymentAmount {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for PaymentConsentPeriodicAmountAmount {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct PaymentInitiationOptionalRestrictionBacs {
    ...
    #[serde(rename = "RecipientBACS")]
    pub recipient_bacs: Option<RecipientBacs>,
}
impl std::fmt::Display for PaymentInitiationOptionalRestrictionBacs {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
pub struct PaymentInitiationPaymentGetResponse {
    ...
    #[serde(rename = "PaymentInitiationPayment")]
...
pub struct PaymentInitiationRecipientGetResponse {
    ...
    #[serde(rename = "PaymentInitiationRecipient")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PaystubVerificationStatus(pub serde_json::Value);
#[derive(Debug, Serialize, Clone, Deserialize, Default)]
...
pub struct ProjectedIncomeSummaryFieldNumber {
    ...
    #[serde(rename = "IncomeSummaryFieldNumber")]
    pub income_summary_field_number: Option<IncomeSummaryFieldNumber>,
}
impl std::fmt::Display for ProjectedIncomeSummaryFieldNumber {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for RecipientBacsNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for ScopesNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for SenderBacsNullable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for WalletTransactionCounterpartyBacs {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for YtdGrossIncomeSummaryFieldNumber {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
...
impl std::fmt::Display for YtdNetIncomeSummaryFieldNumber {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
